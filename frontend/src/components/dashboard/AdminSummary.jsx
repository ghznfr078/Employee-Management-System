  ...
  return (
    <div className='p-6'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-6'>
        ...
        <SummaryCard icon={<FaMoneyBillWave/>} text="Monthly Salary" number="$342" color="bg-red-600" />
        </div>
        <div className='mt-12'>
            ...
            <SummaryCard icon={<FaTimesCircle/>} text="Leave Pending" number={2} color="bg-red-600" />
            </div>
        </div>
